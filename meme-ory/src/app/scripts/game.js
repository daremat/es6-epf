(function() {   // TODO remove closure
    ...
    /* method GameComponent.gameOver */
    GameComponent.prototype.gameOver = gameOver;
    ...
    function gameOver() {
        ...
        setTimeout(function() {  // TODO use arrow function.
            window.location = `game-over.html?name=${this._name}&size=${this._size}&time=${timeElapsedInSeconds}`;
